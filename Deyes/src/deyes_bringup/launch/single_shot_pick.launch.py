...
def generate_launch_description() -> LaunchDescription:
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("require_nav_gate",default_value="false"),
        ...
        Node(package="deyes_stereo",executable="single_shot_snapshot",name="single_shot_snapshot_node",output="screen",parameters=[params,common,{"log_root":LaunchConfiguration("log_root"),"require_nav_gate":LaunchConfiguration("require_nav_gate")}]),

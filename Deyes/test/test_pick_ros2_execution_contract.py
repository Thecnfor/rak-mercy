...
def _coordinate(): return {"trusted_for_execution": True, "frame_id": "base_link", "calibration_id": "measured"}
def _plan(): return {"state": "dry_run_ready", "commands_emitted": False, "steps": [{"name": "pre_grasp", "kind": "cartesian_intent"}, {"name": "close_gripper", "kind": "gripper_intent"}]}
def _gates(**changes):
